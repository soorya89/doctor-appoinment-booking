        ...
        <div className='grid md:grid-cols-3 gap-10'>
            <div className='pb-[50px] px-[30px] rounded-md'>
                ...
                <div className='text-center mt-4'>
                    <h3 className='text-[18px] leading-[30px] text-headingColor font-bold'>Example</h3>
                    ...
                    <span className='ml-2 text-headingColor text-[22px] leading-8'>O-ve</span></p>
                </div>
                <div className='mt-[50px] md:mt-[100px]'>
                  {/* <button className='w-full bg-[#181A1E] p-3 text-[16px] leading-7 rounded-md text-white'>Logout</button>   */}
                  <button className='w-full bg-red-600 p-3 text-[16px] leading-7 rounded-md text-white'>Delete</button>
                </div>
            </div>
