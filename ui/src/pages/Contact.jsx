  ...
  return (
    <section>
      <div className='px-4 mx-auto max-w-screen-md'>
        ...
        <div>
          <label className='sm:col-span-2' htmlFor='message'>Your Message</label>
          <textarea type='text' id='message' rows='6' placeholder='Leave a comment...' className='form__input mt-1'/>
        </div>
