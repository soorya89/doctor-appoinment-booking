  ...
  <>
      <div>
        <h3 className='text-[20px] leading-[30px] text-headingColor font-semibold flex items-center gap-2'>
            About of
            <span className='text-irisBlueColor font-bold text-[24px] leading-9'> Sabu Paul</span>
        </h3>
        <p className='text__para ]'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, ratione dolores expedita eveniet, enim harum nobis cumque iste facere numquam sit praesentium inventore animi qui omnis hic ad saepe minima voluptates neque mollitia soluta voluptatem voluptate. Ad ea sed consequuntur possimus fuga molestias earum neque distinctio necessitatibus voluptatem, iure aspernatur!
        </p>
      </div>
